...
export class sOlympus__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class sOlympus extends ethereum.SmartContract {
  static bind(address: Address): sOlympus {
    return new sOlympus("sOlympus", address);
  }
  ...
  rebases(param0: BigInt): sOlympus__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new sOlympus__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(param0: BigInt): ethereum.CallResult<sOlympus__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
