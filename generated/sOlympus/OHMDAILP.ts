...
export class OHMDAILP__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class OHMDAILP__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class OHMDAILP extends ethereum.SmartContract {
  static bind(address: Address): OHMDAILP {
    return new OHMDAILP("OHMDAILP", address);
  }
  ...
  burn(to: Address): OHMDAILP__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new OHMDAILP__burnResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_burn(to: Address): ethereum.CallResult<OHMDAILP__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new OHMDAILP__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): OHMDAILP__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new OHMDAILP__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<OHMDAILP__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OHMDAILP__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
